...
export const findCommonItems = (firstArray, secondArray) => {
  ...
  const common = [...firstSet.intersection(secondSet)];
...
/**
 * Time Complexity (Original): O(N * M) — The original code used .filter() on the first list and .includes() on the second list. Because .includes() has to look through the second list one item at a time from scratch, it acts like a hidden nested loop. For big lists, this gets incredibly slow.
